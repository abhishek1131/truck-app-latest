...
const mockStats = {
  totalTechnicians: 127,
  activeTechnicians: 98,
  totalOrders: 1247,
  pendingOrders: 23,
  totalRevenue: 156780.5,
  monthlyRevenue: 23450.75,
  totalCredits: 8934.25,
...
const mockRecentActivity = [
  {
    id: 1,
    type: "order",
    message: "New order #ORD-1247 from Mike Rodriguez",
    time: "2 minutes ago",
    status: "new",
  },
  {
    id: 2,
    type: "technician",
    message: "Sarah Chen completed registration",
    time: "15 minutes ago",
    status: "success",
  },
  {
    id: 3,
    type: "redemption",
    message: "Credit redemption request from David Thompson",
    time: "1 hour ago",
    status: "pending",
  },
  {
    id: 4,
    type: "order",
    message: "Order #ORD-1245 marked as completed",
    time: "2 hours ago",
    status: "success",
  },
  {
    id: 5,
    type: "supply_house",
    message: "ABC Supply Co. updated inventory",
    time: "3 hours ago",
    status: "info",
  },
]
...
const mockTopPerformers = [
  { name: "Mike Rodriguez", orders: 45, credits: 234.5, efficiency: 98 },
  { name: "Sarah Chen", orders: 38, credits: 198.75, efficiency: 95 },
  { name: "David Thompson", orders: 32, credits: 167.25, efficiency: 92 },
  { name: "Lisa Wang", orders: 29, credits: 145.8, efficiency: 89 },
  { name: "James Wilson", orders: 27, credits: 138.9, efficiency: 87 },
]
...
export default function AdminDashboardPage() {
  ...
  return (
    <Navigation title="Admin Dashboard" subtitle="Comprehensive overview of your TruXtoK platform">
      <div className="p-4 md:p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          <Card className="bg-gradient-to-br from-[#10294B] to-[#006AA1] text-white border-0 shadow-lg">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{mockStats.totalTechnicians}</div>
              <p className="text-xs opacity-75">
                <span className="text-green-300">{mockStats.activeTechnicians} active</span>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0 shadow-lg">
            ...
            <CardContent>
              ...
              <p className="text-xs opacity-75">
                <span className="text-yellow-300">{mockStats.pendingOrders} pending</span>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-[#E3253D] to-red-600 text-white border-0 shadow-lg">
            ...
            <CardContent>
              ...
              <p className="text-xs opacity-75">
                <span className="text-green-300">+${mockStats.monthlyRevenue.toLocaleString()} this month</span>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white border-0 shadow-lg">
            ...
            <CardContent>
              <div className="text-2xl font-bold">${mockStats.totalCredits.toLocaleString()}</div>
              <p className="text-xs opacity-75">
                <span className="text-yellow-300">{mockStats.pendingRedemptions} pending redemptions</span>
              </p>
            </CardContent>
          </Card>
        </div>
                ...
                {mockRecentActivity.map((activity) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {activity.status === "info" && <Activity className="h-4 w-4 text-gray-600" />}
                    </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-green-100 text-green-800">
                  {((mockStats.activeTechnicians / mockStats.totalTechnicians) * 100).toFixed(1)}%
                </Badge>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Avg Order Value</span>
                <span className="text-sm font-semibold">
                  ${(mockStats.totalRevenue / mockStats.totalOrders).toFixed(2)}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Credit Rate</span>
                <span className="text-sm font-semibold">
                  {((mockStats.totalCredits / mockStats.totalRevenue) * 100).toFixed(2)}%
                </span>
              </div>
              <div className="flex items-center justify-between">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Leading technicians by orders and efficiency</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">{performer.orders} orders completed</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-6">
                    <div className="text-right">
                      <div className="text-sm font-medium text-green-600">${performer.credits.toFixed(2)}</div>
        ...
        <div className="grid md:grid-cols-4 gap-6">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
              ...
              <CardContent className="text-center">
                <Button className="w-full bg-[#10294B] hover:bg-[#006AA1]">
                  <Badge className="mr-2 bg-green-100 text-green-800 text-xs">New</Badge>
                  Manage Fleet
                </Button>
              </CardContent>
            </Card>
          ...
          <Link href="/admin/technicians">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
              ...
              <CardContent className="text-center">
                <Button className="w-full bg-[#006AA1] hover:bg-[#006AA1]/90">View Technicians</Button>
              </CardContent>
            </Card>
          </Link>
