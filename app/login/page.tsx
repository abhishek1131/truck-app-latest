  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        const redirectUrl = data.redirectUrl || (data.user.role === "admin" ? "/admin" : "/dashboard")
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-[#10294B]">Welcome Back</CardTitle>
            <CardDescription>Enter your credentials to access your trucks</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 p-3 bg-gray-50 rounded-lg text-sm">
              ...
              <p className="text-gray-600">Admin: admin@truxtok.com / admin123</p>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/register" className="text-[#E3253D] hover:underline font-medium">
                  Sign up here
                </Link>
              </p>
            </div>
