...
export function AddSupplyHouseModal({ isOpen, onClose }: AddSupplyHouseModalProps) {
  ...
  const specialtyOptions = ["HVAC", "Electrical", "Plumbing", "Industrial", "General"]
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl h-[85vh] flex flex-col">
        <DialogHeader className="flex-shrink-0">
          <DialogTitle className="text-2xl text-[#10294B]">Add New Supply House</DialogTitle>
          <DialogDescription>Register a new supply house partner</DialogDescription>
        </DialogHeader>
