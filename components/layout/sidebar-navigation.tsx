...
import { Home, Truck, Package, ShoppingCart, RotateCcw, Settings, LogOut, Users, Shield } from "lucide-react"
    ...
    <>
      ...
      >
          ...
          <div className="flex items-center space-x-3">
            ...
            {isExpanded && (
              <div className="flex flex-col">
                <span className="text-lg font-bold text-[#10294B]">TruXtoK</span>
                <span className="text-xs text-gray-500">{user?.role === "admin" ? "Administrator" : "Technician"}</span>
              </div>
            )}
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "bg-[#E3253D] text-white" : "text-gray-700 hover:bg-gray-100 hover:text-[#10294B]",
                )}
              >
        ...
        <div className="border-t border-gray-200 p-2 flex-shrink-0">
          {user && (
            <div className={cn("flex items-center px-3 py-2", isExpanded ? "space-x-3" : "justify-center")}>
