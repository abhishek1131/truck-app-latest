...
export function SelectInventoryItemModal({ truckId, binId, onItemSelected }: SelectInventoryItemModalProps) {
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Add Item to Bin
            <span className="text-sm font-normal text-gray-500">- Truck #{truckId.padStart(3, "0")}</span>
          </DialogTitle>
        </DialogHeader>
            ...
            <>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">Selected Item:</h4>
                  <div className="flex items-center space-x-3">
                    <div className="w-12 h-12 bg-[#10294B] rounded-lg flex items-center justify-center">
                      <Package className="h-6 w-6 text-white" />
                    </div>
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs text-gray-500">{selectedItem.unit}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    This will be the initial stock quantity for this item in this specific bin.
                  </p>
                </div>
              </div>
            </>
